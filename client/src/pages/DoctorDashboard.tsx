            ...
            {selectedAppointment ? (
              <div className="glass-card rounded-2xl overflow-hidden flex flex-col ai-gradient-border shadow-2xl">
                ...
                <div className="p-5 flex flex-col gap-5 text-xs">
                  ...
                  <div>
                    <h5 className="font-heading font-bold text-on-surface-variant uppercase tracking-wider text-[11px] mb-2">
                      Chief Complaint Analysis
                    </h5>
                    <p className="text-xs text-white bg-surface-container-low p-3.5 rounded-xl border border-outline-variant/20 leading-relaxed italic">
                      "{selectedAppointment.preVisitSummary?.chiefComplaint || selectedAppointment.symptoms}"
                    </p>
                  </div>

                  {/* AI Suggestions */}
                  <div className="space-y-2.5">
                    <h5 className="font-heading font-bold text-secondary flex items-center gap-1.5 text-xs">
                    ...
                    <div className="flex flex-col gap-2">
                      {selectedAppointment.preVisitSummary?.suggestedQuestions && selectedAppointment.preVisitSummary.suggestedQuestions.length > 0 ? (
                        selectedAppointment.preVisitSummary.suggestedQuestions.map((q, idx) => (
                          <div
                            key={idx}
                            className="bg-surface-container-low p-3 rounded-xl border border-secondary-container/30 hover:border-secondary/50 transition-colors group"
                          >
                            <div className="flex items-start gap-2.5">
                              <span className="material-symbols-outlined text-secondary text-base mt-0.5 group-hover:scale-110 transition-transform">
                                help_center
                              </span>
                        ...
                        <div className="bg-surface-container-low p-3 rounded-xl border border-white/5 text-on-surface-variant">
                          Standard diagnostic assessment recommended for reported clinical history.
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {selectedAppointment.status === 'BOOKED' ? (
                    <button
                      ...
                      className="w-full mt-2 py-3 rounded-xl bg-primary hover:bg-primary-container text-on-primary font-heading font-bold text-xs hover:brightness-110 transition-all shadow-neon-cyan flex items-center justify-center gap-2"
                    >
